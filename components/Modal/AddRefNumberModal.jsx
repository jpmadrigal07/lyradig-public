...
export default function AddRefNumberModal({
  open = false,
  setOpen,
  agreeButtonText,
  setReferenceNumber,
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500 mb-4">
                        {
                          'By adding reference number to this withdrawal, the system will assume that you already send the funds to the client, therefore, we will change the status of this withdrawal to "Approved".'
                        }
                      </p>
                      <label
                        htmlFor="comment"
